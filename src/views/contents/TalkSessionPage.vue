    ...
    const collaborators = [
      {
        ...
        name: 'すいのこ',
        sentence: '1990年、鹿児島県生まれ。本名・桑元康平。鹿児島大学大学院で焼酎製造学を専攻。卒業後、大手焼酎メーカー勤務を経て2017年に上京、eスポーツのイベント運営等を行うウェルプレイド株式会社に企画職として就職。2019年5月より、同社のスポンサードを受け、「大乱闘スマッシュブラザーズ」シリーズのプロ選手として活動中。'
      },
      {
        imageSize: 160,
